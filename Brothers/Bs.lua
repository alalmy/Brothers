...
print("The File "..name.." Not Bsing in The Source max")
end 

end
else
print("The File Script.lua Not Bsing in The Source max")
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/MAXTELE/MAX/master/Brothers/Bs.lua','./Brothers/Bs.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/MAXTELE/MAX/master/Brothers/locks.lua','./Brothers/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/MAXTELE/MAX/master/Brothers/Script.lua','./Brothers/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/MAXTELE/MAX/master/Brothers/functions.lua','./Brothers/functions.lua')
