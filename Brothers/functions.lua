...
var = 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(brothers..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي👷🏽' 
...
if msg.edited then
redis:Brothersr(brothers..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:Brothersr(brothers..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:Brothersr(brothers..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:Brothersr(brothers..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:Brothersr(brothers..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:Brothersr(brothers..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:Brothersr(brothers..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:Brothersr(brothers..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:Brothersr(brothers..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
Save_Data:close()
sendDocument(msg.chat_id_,msg.id_,"./Brothers/"..Bot_User..".json","🚸| ملف النسخه الاحتياطيه ...\n🔖| المجموعات » { "..#All_Groups_ID.." }\n📋| للبوت » "..Bot_User.."\n📆| التاريخ » "..os.date("%Y/%m/%d").."\n",dl_cb,nil)
end
...
file = io.open("./Brothers/All_Groups.html", "w")
file:write([[
<html dir="rtl">
<head>
...
file:close()
return sendDocument(msg.chat_id_,msg.id_,'./Brothers/All_Groups.html','👨🏽‍✈️┇قائمه المجموعات بالكامله ✓ \n🗃┇يحتوي ('..#list..') مجموعه \n🖥┇افتح الملف في عارض HTML او بالمتصفح',dl_cb,nil)
else 
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(brothers..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(brothers..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
if redis:sismember(brothers..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(brothers..'username:'..UserID,'username',Resolv)
redis:sadd(brothers..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇ العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تمت ترقيته ليصبح منشىء اساسي في البوت \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(brothers..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(brothers..':KARA_BOT:'..ChatID,UserID)
...
.."\n📝╿التعديل «» "..(redis:get(brothers..'lock_edit'..msg.chat_id_) or 'false')
...
.."\n🏌🏻│بالطرد البوتات «» "..(redis:get(brothers..'lock_bots_by_kick'..msg.chat_id_) or 'false')
...
.."\n*➕╽*عدد التكرار «» "..(redis:get(brothers..'num_msg_brothers'..msg.chat_id_) or 'false')
.."\n┄─┅═ـ═┅─┄\n*👨‍💻*اعدادات التقـييد :\n"
.."\n*💢╿*التقييد بالتوجيه «» "..(redis:get(brothers..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸│*التقييد بالصور «» "..(redis:get(brothers..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗│*التقييد بالروابط «» "..(redis:get(brothers..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉│*التقييد بالمتحركه «» "..(redis:get(brothers..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥╽*التقييد الفيديو «» "..(redis:get(brothers..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
